  ...
  if (tweetContent.value === "") {
    ...
    posts.forEach((i) => {
      ...
      postRetweet.addEventListener("click" , function(){
        createTweet({ name: "Hamza ",userName: "@hamzaghazal8" , content: i.content });
      });
...
createTweet({ name: "Hamza",userName: "@hamzaghazal8" , content: tweetContent.value });
});
